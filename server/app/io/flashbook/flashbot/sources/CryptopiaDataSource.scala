...
//import io.flashbook.flashbot.core.{Ask, Bid, DataSource, MarketData, Timestamped, Ladder => _, _}
...
//        var tl: TimeLog[LadderMD] = timeLog[LadderMD](dataDir, topic, dataType)
...
//
//  def ordersToAggBookMD(orders: Orders, micros: Long): LadderMD = {
//    var book = LadderType(math.max(orders.Buy.length, orders.Sell.length))
...
//    LadderMD(SRC, orders.Market.toLowerCase, micros, book)
//  }
//
