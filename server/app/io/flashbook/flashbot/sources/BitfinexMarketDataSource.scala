...
class BitfinexMarketDataSource extends DataSource {
  override def ingestGroup(dataDir: String, topics: Map[String, Json], dataTypes: Map[String, DataSource.DataTypeConfig])(implicit sys: ActorSystem, mat: ActorMaterializer) = ???
