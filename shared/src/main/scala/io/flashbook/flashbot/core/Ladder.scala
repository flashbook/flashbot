...
import io.flashbook.flashbot.core.DataType.LadderType
import io.flashbook.flashbot.core.MarketData.HasProduct
...
//  case class LadderMD(source: String,
//                      topic: String,
//                      micros: Long,
//                      data: Ladder) extends GenMD[Ladder] with HasProduct {
